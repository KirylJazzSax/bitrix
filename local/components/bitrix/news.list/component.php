...
// Подгружаем мой класс NewsUtils
Loader::includeModule('newsutils');
...
$arParams['SHOW_SPECIALDATE_META'] = $this->getParent()->arParams['SHOW_SPECIALDATE_META'];
...
if($this->startResultCache(false, array(($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()), $bUSER_HAVE_ACCESS, $arNavigation, $arrFilter, $pagerParameters)))
{
    ...
    $newsUtils = new \Local\NewsUtils\NewsUtils($this, $APPLICATION);
	$newsUtils->abortCacheIfSpecialParamSet();
	...
	$newsUtils->setSpecialdateProperty();
}
